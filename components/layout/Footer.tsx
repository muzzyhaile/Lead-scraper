  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { label: 'Demo', onClick: () => onNavigate?.('demo') },
      ],
    },
    {
      title: 'Company',
    ...
    },
    {
      title: 'Resources',
      links: [
        { label: 'Documentation', onClick: () => onNavigate?.('docs') },
        { label: 'Help Center', onClick: () => onNavigate?.('help') },
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Security', onClick: () => onNavigate?.('security') },
      ],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-white">Prospect Finder</span>
          </div>
          
          <p className="text-sm">
            © {currentYear} Prospect Finder. All rights reserved.
          </p>
